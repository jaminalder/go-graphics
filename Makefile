...
.PHONY: help build test lint fmt vet check tidy golden clean preview preview-qql preview-pools preview-foam preview-scree preview-riffle preview-iris preview-glaze preview-flame hatchbook sweep
...
preview-flame: ## Render the flame sketch for first review (1000², quality 80)
	go run ./cmd/staticart render flame --width 1000 --height 1000 --quality 80 --palette zander-spindle --structure spindle --tint split --ground void --out out
